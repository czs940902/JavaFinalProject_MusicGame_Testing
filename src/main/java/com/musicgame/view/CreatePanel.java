...
public class CreatePanel implements IPanel {
    ...
    public CreatePanel() {
        ...
        // Dialog title
        Label dialogTitle = new Label("新增譜面");
        ...
        // Buttom side buttons
        Button importButton = new Button("匯入");
        Button cancelButton = new Button("取消");
        Button nextButton = new Button("下一步");
        importButton.setPrefSize(200, 80);
        ...
        String buttomButtonStyle = """
                ...
                -fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.4), 10, 0, 0, 4);
                """;
        importButton.setStyle("-fx-background-color: #C9C9C9; -fx-text-fill: black;" + buttomButtonStyle);
        ...
        AnchorPane.setLeftAnchor(importButton, 40.0);
        AnchorPane.setTopAnchor(importButton, 780.0);
